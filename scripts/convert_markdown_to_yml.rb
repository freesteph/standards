...
# Compile all Markdown files into one big YAML file
def compile_all_to_yml
  ...
  File.write('all_markdown_rules.yml', all_data.to_yaml)
  puts "Compiled all Markdown files into all_markdown_rules.yml"
end
